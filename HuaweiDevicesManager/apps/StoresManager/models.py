...
class Store(models.Model):
    ...
    district_code = models.CharField(max_length=10, unique=True, blank=True, null=True)  # 区号字段
    category = models.CharField(max_length=50)  # 店铺类别（如：奶茶店、果茶店等）
    rating = models.DecimalField(max_digits=3, decimal_places=2, default=0)  # 评分
